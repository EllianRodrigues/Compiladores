...
def serializedATN():
    return [
        ...
        7,27,1,0,0,0,9,29,1,0,0,0,11,32,1,0,0,0,13,37,1,0,0,0,15,41,1,0,
        ...
        28,8,1,0,0,0,29,30,5,61,0,0,30,10,1,0,0,0,31,33,7,0,0,0,32,31,1,
        0,0,0,33,34,1,0,0,0,34,32,1,0,0,0,34,35,1,0,0,0,35,12,1,0,0,0,36,
        ...
        48,49,1,0,0,0,49,50,1,0,0,0,50,51,6,9,0,0,51,20,1,0,0,0,4,0,34,39,
        48,1,6,0,0
    ]
...
class ArithmeticLexer(Lexer):
    ...
    symbolicNames = [ "<INVALID>",
            "PLUS", "MINUS", "MUL", "DIV", "ASSIGN", "VAR", "INT", "LPAREN", 
            "RPAREN", "WS" ]

    ruleNames = [ "PLUS", "MINUS", "MUL", "DIV", "ASSIGN", "VAR", "INT", 
                  "LPAREN", "RPAREN", "WS" ]
