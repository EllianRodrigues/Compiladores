...
def serializedATN():
    return [
        ...
        22,5,6,0,0,22,23,5,5,0,0,23,24,3,6,3,0,24,5,1,0,0,0,25,30,3,8,4,
        ...
        0,0,0,38,39,1,0,0,0,39,9,1,0,0,0,40,38,1,0,0,0,41,48,5,7,0,0,42,
        48,5,6,0,0,43,44,5,8,0,0,44,45,3,6,3,0,45,46,5,9,0,0,46,48,1,0,0,
...
class ArithmeticParser ( Parser ):
    ...
    symbolicNames = [ "<INVALID>", "PLUS", "MINUS", "MUL", "DIV", "ASSIGN", 
                      "VAR", "INT", "LPAREN", "RPAREN", "WS" ]
